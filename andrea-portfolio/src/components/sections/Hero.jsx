        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-12">
              Specializing in React, Vite, and Tailwind CSS. Building modern and responsive web applications
            ...
            <div className="flex flex-wrap justify-center gap-6 text-gray-400">
              <span className="flex items-center gap-2">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.25c5.385 0 9.75 4.365 9.75 9.75s-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12 6.615 2.25 12 2.25zm0 4.5c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5z"/>
                </svg>
                React
              </span>
              <span className="flex items-center gap-2">
